...
namespace MMS_Darko_Stosic_16413
{
    class ShannonFano
    {
		...
		//public static int Compress16(ushort[] input, byte[] output, ushort inputSize)
		//{
		//	Symbol[] sym = new Symbol[65536];
		//	Symbol temp;
		//	BitStream stream = new BitStream();
		//	ushort i, totalBytes, swaps, symbol, lastSymbol;
		...
		//	for (lastSymbol = 65535; sym[lastSymbol].Count == 0; --lastSymbol) ;
